...
<div align="center">
 ...
 <th> First name:<br></th>
  ...
  <tr>
  	<th>
  Last name:<br></th>
 <th> <input type="text" name="lastname" placeholder="Enter last name" >
  <br></th>
</tr>
...
<tr>
  	<th>
  Father's Name:<br></th>
 <th> <input type="text" name="fathername" placeholder="Enter father's name" >
  <br></th>
</tr>
...
<tr>
  	<th>
  Mobile:<br></th>
 <th> <input type="text" name="mobile" placeholder="Enter mobile number" >
  <br></th>
</tr>
...
<tr>
  	<th>
  Address:<br></th>
 <th> <input type="text" name="address" placeholder="Enter employee's address" >
  <br></th>
</tr>
...
<tr>
  	<th>
 Posting:<br></th>
 <th> <input type="text" name="posting" placeholder="Employee's post" >
  <br></th>
</tr>
<br>
<br>
...
if(isset($_POST['addemployee']))
{
	...
	if(preg_match($mobileregex, $mobile) ) {
			...
			return substr(md5(uniqid(mt_rand(), true)), 0, $l);
			 ...
			 $sql="INSERT INTO `employee` (`firstname`, `lastname`, `DOB`, `fathername`, `mobile`, `email`,`address`, `DOJ`, `post`, `photo`, `password`, `days`, `payment`) 
			 VALUES ( '$firstname', '$lastname', '$dob', '$fathername', '$mobile', '$email','$address', '$doj', '$posting', '$imagename', '$password', '0', '0');";
